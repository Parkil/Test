...
public class ApahceHttpSMRCall {
	...
	public String callHttpGet(String base_url, Map<String,String> param_map, int time_out) throws ApiCallException, ClientProtocolException, IOException{
		...
		RequestConfig requestConfig = RequestConfig.custom().setConnectionRequestTimeout(time_out).setConnectTimeout(time_out).setSocketTimeout(time_out)
		...
		if(response.getStatusLine().getStatusCode() != HttpStatus.SC_OK) {
			throw new ApiCallException("API호출시 문제가 발생하였습니다. HTTP StatusCode : "+response.getStatusLine().getStatusCode());
		}
